using SinergicFailureAftermath.Classes;
using System;
...
namespace SinergicFailureAftermath
{
    internal class Link:P_Link
    {
        ...
        private Link[] Connected_links; //Связанные узлы
        public int getIndex() { return Index; }
        public int GetLinks() => Links;
        public Link(int Index,int IDType) { this.Index = Index;_type = setType(IDType); }//Добавить узел
        public int AddConnectedLink(Link AddLink) { Connected_links[Links]= AddLink;Links++; return 0; }//Связывание с узлом
